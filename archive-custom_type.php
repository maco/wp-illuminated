				    ...
				    <div id="main" class="ninecol first clearfix" role="main">
					    ...
					    <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						    ...
						    <header class="article-header">
							    ...
							    <p class="byline vcard"><?php _e("Posted", "illuminatedtheme"); ?> <time class="updated" datetime="<?php echo the_time('Y-m-d'); ?>" ><?php the_time('F jS, Y'); ?></time> <?php _e("by", "illuminatedtheme"); ?> <span class="author"><?php the_author_posts_link(); ?></span>.</p>
					    ...
					    <?php else : ?>
    					    ...
    					    <article id="post-not-found" class="hentry clearfix">
    	    					...
    	    					<footer class="article-footer">
    		    				    <p><?php _e("This is the error message in the custom posty type archive template.", "illuminatedtheme"); ?></p>
    			    			</footer>
    				    	</article>
