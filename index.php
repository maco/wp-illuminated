				    ...
				    <div id="main" class="eightcol first clearfix" role="main">
					    ...
					    <?php else : ?>
					        ...
					        <article id="post-not-found" class="hentry clearfix">
					            <header class="article-header">
					        	    <h1><?php _e("Oops, Post Not Found!", "illuminatedtheme"); ?></h1>
					        	</header>
					            <section class="entry-content">
					        	    <p><?php _e("Uh Oh. Something is missing. Try double checking things.", "illuminatedtheme"); ?></p>
					        	</section>
					        	<footer class="article-footer">
					        	    <p><?php _e("This is the error message in the index.php template.", "illuminatedtheme"); ?></p>
					        	</footer>
					        </article>
