			...
			<div id="content">
				...
				<div id="inner-content" class="wrap clearfix">
				    ...
				    <div id="main" class="ninecol first clearfix" role="main">
					    ...
					    <h2 class="archive-title h2"><span><?php _e("Posts Categorized:", "illuminatedtheme"); ?></span> <?php single_cat_title(); ?></h2>
					    ...
					    <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						    ...
						    <header class="article-header">
							    ...
							    <p class="byline vcard"><?php _e("Posted", "illuminatedtheme"); ?> <time class="updated" datetime="<?php echo the_time('Y-m-d'); ?>" ><?php the_time('F jS, Y'); ?></time> <?php _e("by", "illuminatedtheme"); ?> <span class="author"><?php the_author_posts_link(); ?></span> <span class="amp">&</span> <?php _e("filed under", "illuminatedtheme"); ?> <?php echo get_the_term_list( get_the_ID(), 'custom_cat', "" ) ?>.</p>
					    ...
					    <?php else : ?>
        					...
        					<article id="post-not-found" class="hentry clearfix">
        						...
        						<footer class="article-footer">
        						    <p><?php _e("This is the error message in the taxonomy-custom_cat.php template.", "illuminatedtheme"); ?></p>
        						</footer>
        					</article>
